...
def OCTgetRawData(directory,header,spectrumindex=0):
    ...
    # hier krijg ik een errror en moet ik gaan kijken wat wel in de directory zit en dan de namen aanpassen.
    #print(type(directory))
    #print('Hier zijn de bestanden in de zipfile: ', directory.namelist())
    #print('Kijk in dit bestand of de juiste worden geopend.')
...
def OCTgetProcessedImage(filepath,imtype='RGB'):
    '''
